				...
				for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += "<td class='" +
							...
							// jsk edit s
							" date" + printDate.getFullYear()+ ((printDate.getMonth()+1) < 10 ? '0'+(printDate.getMonth() +1) : printDate.getMonth() +1) + (printDate.getDate() < 10 ? '0' + printDate.getDate() : printDate.getDate()) +
							// jsk edit e
