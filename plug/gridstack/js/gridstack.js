    ...
    */
    ...
    var GridStack = function(el, opts) {
        ...
        this.opts = _.defaults(opts || {}, {
            width: parseInt(this.container.attr('data-gs-width')) || 50,
    ...
    GridStack.prototype.addWidget = function(el, x, y, width, height, autoPosition, minWidth, maxWidth, minHeight, maxHeight, param, id) {
        el = $(el);
        ...
        if (typeof param != 'undefined') { el.attr('data-gs-param', param); }
    ...
    GridStack.prototype.setGridParam = function(el, param) {
    	this._updateElement(el, function(el, node) {
    		node.param = param;
            el.data('_gridstack_node', node);
        });
